...
MySQL.prototype.executeSQL = function(sql, params, options, callback) {
 ...
 MySQL.prototype.modifyOrCreate = function(model, data, options, buildFunc ,callback) {   
    var fields = this[buildFunc](model, data);
 ...
 * @param {Function} [callback] The callback function
 */
MySQL.prototype.replaceOrCreate = function (model, data, options, callback) {
  this.modifyOrCreate(model, data, options, 'buildReplaceFields', callback);
}
 ...
 * @param {Function} [callback] The callback function
 */
MySQL.prototype.updateOrCreate = function (model, data, options, callback) {
  this.modifyOrCreate(model, data, options, 'buildFields', callback);
}
